# campaigns/xvendor_bench_b300_newton.sh — the cross-vendor cells on ONE B300 with the ARTICLE's
...
# 737) and is kept as data under xvendor_bench_b300 / _c5.
. "$(dirname "${BASH_SOURCE[0]}")/xvendor_bench_common.sh"
CAMPAIGN=xvendor_bench_b300_newton
CELLS=(
