...
CELLS=(
  "e5em1|EDM_GAMMA_EPS=0.5 EDM_SPP=32 EDM_TSPAN_TAU=10.666666666666666"
  "e1e0|EDM_GAMMA_EPS=1 EDM_SPP=64 EDM_TSPAN_TAU=8"
  "e2e0|EDM_GAMMA_EPS=2 EDM_SPP=128 EDM_TSPAN_TAU=5.333333333333333"
  "e4e0|EDM_GAMMA_EPS=4 EDM_SPP=512 EDM_TSPAN_TAU=3.2"
  "e9e0|EDM_GAMMA_EPS=9 EDM_SPP=2048 EDM_TSPAN_TAU=1.6"
)
