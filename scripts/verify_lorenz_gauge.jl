...
function get_screens()
    ...
    screen0 = ObserverScreen(x_sub, y_sub, Z, x⁰_samples; c)
    screenm = ObserverScreen(x_sub, y_sub, Z - δz, x⁰_samples; c)
    screenp = ObserverScreen(x_sub, y_sub, Z + δz, x⁰_samples; c)
