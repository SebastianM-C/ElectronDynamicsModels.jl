...
const COEF_REUSE = haskey(ENV, "EDM_COEF_REUSE") ? ENV["EDM_COEF_REUSE"] == "1" : (ACCUM_ALG == "newton" && GPU_BACKEND == "rocm")
...
# (`buffers`), and the fold of the batch's host-side products. Nothing is downloaded here — the
