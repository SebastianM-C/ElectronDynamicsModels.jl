...
@component function LaguerreGaussLaser(;
    ...
    #
    # TODO(human): incorporate the initial carrier phase ϕ₀ into lg_phase.
    # It must appear exactly once across the E_g · lg_phase product (E_g omits
    # it on purpose — see the note above).
