...
GPM counter sampler (`with_gpm_sampler`, `gpu_gpm_supported`, `gpm_stats`: achieved SM
occupancy and FP64 / DRAM-bandwidth utilization on NVIDIA Hopper and newer GPUs, reduced into
the manifest's `[gpu].gpm_*` fields), the
